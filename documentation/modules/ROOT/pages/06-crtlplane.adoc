...
First at all, it is required to create a new _ServiceMeshMember_ object for being able to add a new project to the Service Mesh.
...
Once your project has been added to the Service Mesh Control Plane, it is required to follow next steps in order to ensure your demo app is running properly:
