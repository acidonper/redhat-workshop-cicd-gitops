...
NOTE: Please, replace *<user_namespace>* with the value provided by the Instructor at the beginning of this tutorial or values obtained from openshift cluster.
