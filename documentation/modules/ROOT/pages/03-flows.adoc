...
TIP: If you are an advanced user and can not wait for your instructor, please visit xref:06-crtlplane.adoc[Istio Control Plane] and follow the instructions there.
