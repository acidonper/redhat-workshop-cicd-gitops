...
TIP: If you are an advanced user and can not wait for the instructor, please visit xref:06-crtlplane.adoc#smr[6.1.1 Create _ServiceMeshMember_ Object] and follow the instructions there.
