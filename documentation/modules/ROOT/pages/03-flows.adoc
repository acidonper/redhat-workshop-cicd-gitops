...
Please, create a new file named *gateways.yml* with the following content replacing *<user_namespace>* and *<openshift_apps_domain>* with the valuess provided by the Instructor at the beginning of this tutorial.
...
Please, create a new file named *virtualservices.yml* with the following content replacing *<user_namespace>* and *<openshift_apps_domain>* with the valuess provided by the Instructor at the beginning of this tutorial.
...
Please, create a new file named *destinationrules.yml* with the following content replacing *<user_namespace>* with the values provided by the Instructor at the beginning of this tutorial.
...
Please, create a new file named *routes.yml* with the following content replacing *<user_namespace>* and *<openshift_apps_domain>* with the valuess provided by the Instructor at the beginning of this tutorial.
