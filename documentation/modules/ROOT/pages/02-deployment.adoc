...
* Create values.yaml file modifying _global.appsDomain_ and _jump-app-cicd.namespaceXXX_ including in *<openshift_apps_domain>* and *<user_namespace>* parameters value respectively provided by the Instructor:
...
jump-app-cicd:
  ...
  namespacePre: <user_namespace>-pre
  namespacePro: <user_namespace>-pro
  enabled: true
...
* Create values.yaml file modifying _global.appsDomain_ and _jump-app-micros.cicd.namespace_ including in *<openshift_apps_domain>* and *<user_namespace>* parameters value respectively provided by the Instructor:
